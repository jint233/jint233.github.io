...
![第05讲 Architecture](assets/第05讲-01.jpg)

 （ Spring Cloud 与 Spring Boot 的版本对应情况，来源于官网）

![第05讲 Architecture](assets/第05讲-02.jpg)
...
![第05讲 Architecture](assets/第05讲-03.jpg)
...
官网地址：[https://github.com/alibaba/spring-cloud-alibaba](https://github.com/alibaba/spring-cloud-alibaba) 它是 Spring Cloud 的一个子项目，致力于提供微服务开发的一站式解决方案，项目包含开发分布式应用服务的必需组件，方便开发者通过 Spring Cloud 编程模型轻松使用这些组件来开发分布式应用服务，只需要添加一些注解和少量配置，就可以将 Spring Cloud 应用接入阿里分布式应用解决方案，通过阿里中间件来迅速搭建分布式应用系统。 项目特性见下图：

![第05讲 Architecture](assets/第05讲-04.jpg)
...
![第05讲 Architecture](assets/第05讲-05.jpg)
