...
![img](../assets/Java 面试题集锦（网络篇）-1.jpg)
...
![img](../assets/Java 面试题集锦（网络篇）-2.jpg)

UDP 客户端执行结果：

![img](../assets/Java 面试题集锦（网络篇）-3.jpg)
...
![img](../assets/Java 面试题集锦（网络篇）-4.jpg)

TCP 客户端执行结果：

![img](../assets/Java 面试题集锦（网络篇）-5.jpg)
...
![img](../assets/Java 面试题集锦（网络篇）-6.jpg)
...
![img](../assets/Java 面试题集锦（网络篇）-7.jpg)

第二种情况发生了明显的粘包现象，这种情况对于数据接收方来说很难处理。

![img](../assets/Java 面试题集锦（网络篇）-8.jpg)

接下来的两种情况发生了粘包和拆包的现象，接收端收到的数据包要么是不完整的要么是多出来一块儿。

![img](../assets/Java 面试题集锦（网络篇）-9.jpg)

![img](../assets/Java 面试题集锦（网络篇）-10.jpg)
...
![img](../assets/Java 面试题集锦（网络篇）-11.jpg)
...
![img](../assets/Java 面试题集锦（网络篇）-14.jpg)
...
![img](../assets/Java 面试题集锦（网络篇）-15.jpg)
...
![img](../assets/Java 面试题集锦（网络篇）-16.jpg)
...
![img](../assets/Java 面试题集锦（网络篇）-17.jpg)
...
2. 浏览器得到网址对应的服务器的 IP 地址后，通过与服务器三次握手建立 TCP 连接。
   ...
   ![img](../assets/Java 面试题集锦（网络篇）-18.jpg)
...
3. 浏览器与服务器建立好 TCP 连接后，就会发送 HTTP 请求。
   ...
   ![img](../assets/Java 面试题集锦（网络篇）-19.jpg)
...
4. 服务器处理浏览器发送的 HTTP 请求。
   ...
   ![img](../assets/Java 面试题集锦（网络篇）-20.jpg)

5. 服务器返回响应结果。

    在响应头中返回了 HTTP 状态码、HTTP 协议版本、是否为长连接、文本编码类型、日期等等。

   ![img](../assets/Java 面试题集锦（网络篇）-21.jpg)

6. 浏览器和者服务器通过四次挥手关闭 TCP。

   ![img](../assets/Java 面试题集锦（网络篇）-22.jpg)
