...
<figure markdown="span">
  ![图1 两个 join 的查询结果](./assets/202305061610162.png)
...
<figure markdown="span">
  ![图2 Q1 的 explain 结果](./assets/202305061610163.png)
...
<figure markdown="span">
  ![图3 left join -BNL 算法](./assets/202305061610164.jpeg)
...
<figure markdown="span">
  ![图4 Q2 的 explain 结果](./assets/202305061610165.png)
...
<figure markdown="span">
  ![图5 Q2 的改写结果](./assets/202305061610166.png)
...
<figure markdown="span">
  ![图6 join 语句改写](./assets/202305061610167.png)
...
除了性能问题，大家对细节的追问也很到位。在 [第 39 讲《自增主键为什么不是连续的？》](./第39讲.md) 评论区，@帽子掉了同学问到：在 binlog_format=statement 时，语句 A 先获取 id=1，然后语句 B 获取 id=2；接着语句 B 提交，写 binlog，然后语句 A 再写 binlog。这时候，如果 binlog 重放，是不是会发生语句 B 的 id 为1，而语句 A 的 id 为2的不一致情况呢？
...
<figure markdown="span">
  ![图7 insert 语句的 binlog](./assets/202305061610168.png)
