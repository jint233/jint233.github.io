...
![enter image description here](assets/第26讲-01.jpg)
...
![enter image description here](assets/第26讲-02.jpg)
...
5. **开放封闭原则告诉我们要对扩展开放，对修改关闭**。开闭原则可以说是整个设计的最终目标和原则！开闭原则是总纲，其他 4 个原则是对这个原则具体解释。
...
![enter image description here](assets/第26讲-03.jpg)
