...
![Lark20210106-113815.png](assets/第24讲-01.png)
...
![Lark20210106-113819.png](assets/第24讲-02.png){style="width:100%;max-width:800px"}
...
服务提供者启动的配置方式基本是固定模式，也是从引导器 Bootstrap 开始入手，你可以复习下基础课程[《引导器作用：客户端和服务端启动都要做些什么？》](./第03讲.md)。我们首先看下服务提供者的启动实现，代码如下所示：
