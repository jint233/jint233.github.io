...
<figure markdown="span">
  ![图 1 MySQL 主备切换流程](assets/第24讲-01.png)
  <figcaption>图 1 MySQL 主备切换流程</figcaption>
</figure>
...
<figure markdown="span">
  ![图 2 主备流程图](assets/第24讲-02.png)
  <figcaption>图 2 主备流程图</figcaption>
</figure>
...
我在 [第 15 讲](./第15讲.md) 中，和你提到过 binlog 有两种格式，一种是 statement，一种是 row。可能你在其他资料上还会看到有第三种格式，叫作 mixed，其实它就是前两种格式的混合。
...
<figure markdown="span">
  ![第24讲-03](assets/第24讲-03.png)
  <figcaption>图 3 statement 格式 binlog 示例</figcaption>
</figure>
...
- 最后一行是一个 COMMIT。你可以看到里面写着 xid=61。你还记得这个 XID 是做什么用的吗？如果记忆模糊了，可以再回顾一下 [第 15 讲](./第15讲.md) 中的相关内容。

为了说明 statement 和 row 格式的区别，我们来看一下这条 delete 命令的执行效果图：

<figure markdown="span">
  ![第24讲-04](assets/第24讲-04.png)
  <figcaption>图 4 delete 执行 warnings</figcaption>
</figure>
...
<figure markdown="span">
  ![第24讲-05](assets/第24讲-05.png)
  <figcaption>图 5 row 格式 binlog 示例</figcaption>
</figure>
...
<figure markdown="span">
  ![第24讲-06](assets/第24讲-06.png)
  <figcaption>图 6 row 格式 binlog 示例的详细信息</figcaption>
</figure>
...
<figure markdown="span">
  ![第24讲-07](assets/第24讲-07.png)
  <figcaption>图 7 mixed 格式和 now()</figcaption>
</figure>
...
<figure markdown="span">
  ![第24讲-08](assets/第24讲-08.png)
  <figcaption>图 8 TIMESTAMP 命令</figcaption>
</figure>
...
<figure markdown="span">
  ![图 9 MySQL 主备切换流程 -- 双 M 结构](assets/第24讲-09.png)
  <figcaption>图 9 MySQL 主备切换流程 -- 双 M 结构</figcaption>
</figure>
