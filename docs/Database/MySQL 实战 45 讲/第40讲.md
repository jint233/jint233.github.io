...
<figure markdown="span">
  ...
  ![图 1 并发 insert 场景](assets/第40讲-01.png)
...
<figure markdown="span">
  ...
  ![图 2 慢查询日志 -- 将数据插入表 t2](assets/第40讲-02.png)
...
<figure markdown="span">
  ...
  ![图 3 慢查询日志 -- 将数据插入表 t](assets/第40讲-03.png)
...
<figure markdown="span">
  ...
  ![图 4 explain 结果](assets/第40讲-04.png)
...
<figure markdown="span">
  ...
  ![图 5 查看 Innodb_rows_read 变化](assets/第40讲-05.png)
...
<figure markdown="span">
  ...
  ![图 6 唯一键冲突加锁](assets/第40讲-06.png)
...
<figure markdown="span">
  ...
  ![图 7 唯一键冲突 -- 死锁](assets/第40讲-07.png)
...
<figure markdown="span">
  ...
  ![图 8 状态变化图 -- 死锁](assets/第40讲-08.jpg)
...
<figure markdown="span">
  ...
  ![图 9 两个唯一键同时冲突](assets/第40讲-09.png)
