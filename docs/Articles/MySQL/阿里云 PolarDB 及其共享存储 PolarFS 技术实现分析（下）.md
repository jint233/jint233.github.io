...
![图解](../assets/阿里云 PolarDB 及其共享存储 PolarFS 技术实现分析（下）-1.jpg)
...
![图解](../assets/阿里云 PolarDB 及其共享存储 PolarFS 技术实现分析（下）-2.png)
...
![图解](../assets/阿里云 PolarDB 及其共享存储 PolarFS 技术实现分析（下）-3.png)
...
![图解](../assets/阿里云 PolarDB 及其共享存储 PolarFS 技术实现分析（下）-4.png)
...
![图解](../assets/阿里云 PolarDB 及其共享存储 PolarFS 技术实现分析（下）-5.png)
...
![图解](../assets/阿里云 PolarDB 及其共享存储 PolarFS 技术实现分析（下）-6.png)
...
![图解](../assets/阿里云 PolarDB 及其共享存储 PolarFS 技术实现分析（下）-7.png)

4KB 大小的不同请求类型

![图解](../assets/阿里云 PolarDB 及其共享存储 PolarFS 技术实现分析（下）-8.png)

PolarDB 整体性能

**使用不同底层存储时性能表现**![示意图](../assets/阿里云 PolarDB 及其共享存储 PolarFS 技术实现分析（下）-9.png)
**对外展示的性能表现**

![图解](../assets/阿里云 PolarDB 及其共享存储 PolarFS 技术实现分析（下）-10.png)
