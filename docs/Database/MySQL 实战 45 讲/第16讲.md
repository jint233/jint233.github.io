...
<figure markdown="span">
  ![图1 使用 explain 命令查看语句的执行情况](./assets/826579b63225def812330ef6c344a303-1584367390630.png)
...
<figure markdown="span">
  ![图2 city 字段的索引示意图](./assets/5334cca9118be14bde95ec94b02f0a3e-1584367390633.png)
...
<figure markdown="span">
  ![图3 全字段排序](./assets/6c821828cddf46670f9d56e126e3e772-1584367392861.jpg)
...
<figure markdown="span">
  ![图4 全排序的 OPTIMIZER_TRACE 部分结果](./assets/89baf99cdeefe90a22370e1d6f5e6495-1584367392864.png)  
...
<figure markdown="span">
  ![图5 rowid 排序](./assets/dc92b67721171206a302eb679c83e86d-1584367392864.jpg)
...
<figure markdown="span">
  ![图6 rowid 排序的 OPTIMIZER_TRACE 部分输出](./assets/27f164804d1a4689718291be5d10f89b-1584367392865.png)
...
<figure markdown="span">
  ![图7 city 和 name 联合索引示意图](./assets/f980201372b676893647fb17fac4e2bf-1584367392865.png)
...
<figure markdown="span">
  ![图8 引入 (city,name) 联合索引后，查询语句的执行计划](./assets/3f590c3a14f9236f2d8e1e2cb9686692-1584367392865.jpg)
...
<figure markdown="span">
  ![图9 引入 (city,name) 联合索引后，查询语句的执行计划](./assets/fc53de303811ba3c46d344595743358a-1584367392865.png)
...
<figure markdown="span">
  ![图10 引入 (city,name,age) 联合索引后，查询语句的执行流程](./assets/df4b8e445a59c53df1f2e0f115f02cd6-1584367392865.jpg)
...
<figure markdown="span">
  ![图11 引入 (city,name,age) 联合索引后，查询语句的执行计划](./assets/9e40b7b8f0e3f81126a9171cc22e3423-1584367392866.png)
...
<figure markdown="span">
  ![图12 锁验证方式](./assets/6d9d8837560d01b57d252c470157ea90-1584367392866.png)
...
<figure markdown="span">
  ![图13 可见性验证方式](./assets/441682b64a3f5dd50f35b12ca4b87c96-1584367392866.png)
...
<figure markdown="span">
  ![图14 可见性验证方式 -- 对照](./assets/63dd6df32dacdb827d256e5acb9837c1-1584367392866.png)
...
<figure markdown="span">
  ![图15 binlog_row_image=FULL 读字段逻辑](./assets/d413b9235d56c62f9829750a68b06b89-1584367392866.png)
