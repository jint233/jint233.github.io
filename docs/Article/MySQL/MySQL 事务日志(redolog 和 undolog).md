...
![img](../assets/MySQL 事务日志(redolog 和 undolog)-1.png)
...
![img](../assets/MySQL 事务日志(redolog 和 undolog)-2.png)
...
![img](../assets/MySQL 事务日志(redolog 和 undolog)-3.png)
...
![img](../assets/MySQL 事务日志(redolog 和 undolog)-4.png)
...
![img](../assets/MySQL 事务日志(redolog 和 undolog)-5.png)
...
![img](../assets/MySQL 事务日志(redolog 和 undolog)-6.png)
...
![img](../assets/MySQL 事务日志(redolog 和 undolog)-7.png)
...
![img](../assets/MySQL 事务日志(redolog 和 undolog)-8.png)
...
![img](../assets/MySQL 事务日志(redolog 和 undolog)-9.png)
