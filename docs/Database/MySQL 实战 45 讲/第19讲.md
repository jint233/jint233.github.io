...
<figure markdown="span">
  ...
  ![图 1 查询长时间不返回](assets/第19讲-01.png)

  <figcaption>图 1 查询长时间不返回</figcaption>
</figure>
...
<figure markdown="span">
  ...
  ![第19讲-02](assets/第19讲-02.png)

  <figcaption>图 2 Waiting for table metadata lock 状态示意图</figcaption>
</figure>
...
<figure markdown="span">
  ...
  ![第19讲-03](assets/第19讲-03.png)

  <figcaption>图 3 MySQL 5.7 中 Waiting for table metadata lock 的复现步骤</figcaption>
</figure>
...
<figure markdown="span">
  ...
  ![图 4 查获加表锁的线程 id](assets/第19讲-04.png)

  <figcaption>图 4 查获加表锁的线程 id</figcaption>
</figure>
...
<figure markdown="span">
  ...
  ![第19讲-05](assets/第19讲-05.png)

  <figcaption>图 5 Waiting for table flush 状态示意图</figcaption>
</figure>
...
<figure markdown="span">
  ...
  ![第19讲-06](assets/第19讲-06.png)

  <figcaption>图 6 Waiting for table flush 的复现步骤</figcaption>
</figure>
...
<figure markdown="span">
  ...
  ![第19讲-07](assets/第19讲-07.png)

  <figcaption>图 7 Waiting for table flush 的 show processlist 结果</figcaption>
</figure>
...
<figure markdown="span">
  ...
  ![图 8 行锁复现](assets/第19讲-08.png)

  <figcaption>图 8 行锁复现</figcaption>
</figure>

<figure markdown="span">

  ![图 9 行锁 show processlist 现场](assets/第19讲-09.png)

  <figcaption>图 9 行锁 show processlist 现场</figcaption>
</figure>
...
<figure markdown="span">
  ...
  ![第19讲-10](assets/第19讲-10.png)

  <figcaption>图 10 通过 sys.innodb_lock_waits 查行锁</figcaption>
</figure>
...
<figure markdown="span">
  ...
  ![第19讲-11](assets/第19讲-11.png)

  <figcaption>图 11 全表扫描 5 万行的 slow log</figcaption>
</figure>
...
<figure markdown="span">
  ...
  ![第19讲-12](assets/第19讲-12.png)

  <figcaption>图 12 扫描一行却执行得很慢</figcaption>
</figure>
...
<figure markdown="span">
  ...
  ![第19讲-13](assets/第19讲-13.png)

  <figcaption>图 13 加上 lock in share mode 的 slow log</figcaption>
</figure>
...
<figure markdown="span">
  ...
  ![第19讲-14](assets/第19讲-14.png)

  <figcaption>图 14 两个语句的输出结果</figcaption>
</figure>
...
<figure markdown="span">
  ...
  ![第19讲-15](assets/第19讲-15.png)

  <figcaption>图 15 复现步骤</figcaption>
</figure>
...
<figure markdown="span">
  ...
  ![图 16 id=1 的数据状态](assets/第19讲-16.png)

  <figcaption>图 16 id=1 的数据状态</figcaption>
</figure>
