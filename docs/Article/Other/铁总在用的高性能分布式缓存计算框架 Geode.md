...
![图解](../assets/铁总在用的高性能分布式缓存计算框架 Geode-1.png)
...
![图解](../assets/铁总在用的高性能分布式缓存计算框架 Geode-2.png)
...
![图解](../assets/铁总在用的高性能分布式缓存计算框架 Geode-3.png)

![图解](../assets/铁总在用的高性能分布式缓存计算框架 Geode-4.png)

![图解](../assets/铁总在用的高性能分布式缓存计算框架 Geode-5.png)
...
![图解](../assets/铁总在用的高性能分布式缓存计算框架 Geode-10.png)
...
![图解](../assets/铁总在用的高性能分布式缓存计算框架 Geode-11.png)

新的 1.8 的 client 包引入了新的类，这个新的类有 Java 9 的模块化信息，然后这个版本的 Tomcat 是无法扫描模块化 jar 包的。

![图解](../assets/铁总在用的高性能分布式缓存计算框架 Geode-12.png)
...
![图解](../assets/铁总在用的高性能分布式缓存计算框架 Geode-15.png)
...
![图解](../assets/铁总在用的高性能分布式缓存计算框架 Geode-16.png)
...
![图解](../assets/铁总在用的高性能分布式缓存计算框架 Geode-17.png)

![图解](../assets/铁总在用的高性能分布式缓存计算框架 Geode-18.png)
