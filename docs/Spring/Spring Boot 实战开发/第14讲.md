...
![用户账户更新场景中的消息通信机制](assets/第14讲-05.png)
...
![Kafka 基本架构图 **在上图中我们注意到，Kafka 架构图中还使用了 Zookeeper。** Zookeeper 中存储了 Kafka 的元数据及消费者消费偏移量（Offset），其作用在于实现 Broker 和消费者之间的负载均衡。因此，如果我们想要运行 Kafka，首先需要启动 Zookeeper，再启动 Kafka 服务器。](assets/第14讲-07.png)
...
![Kafka 消费者组示意图](assets/第14讲-08.png)
