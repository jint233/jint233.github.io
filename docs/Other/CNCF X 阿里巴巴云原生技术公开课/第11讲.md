...
![avatar](assets/Fnlyp0R6GWpW_Hjt5qT-BLAWHgRc.png))

当这个 pod 指针判断一直处在失败状态的时候，其实接入层的流量不会打到现在这个 pod 上。

![avatar](assets/FmD6io0Bvk_zcZRtG9PweRYbDURX.png))
...
![avatar](assets/Ft-XeNH2zT9hloHcrkQw9oCrMzD5.png)
...
![avatar](assets/Fhk2djtw2BsQ-eFML2EoGe0Zhlz2.png)
...
![avatar](assets/FvEFNoa9tI3JgXGgY1G-TV8Tkhix.png)
...
![avatar](assets/Fn8qTINgCXS_nmxwB8hI4-qtOyOd.png))
...
![avatar](assets/FjWTPaRjEPG-yw_ixjNZaKiuzOkx.png))
...
![avatar](assets/Fv1SNFibPhnu1hzgc4HvJ-XejxEj.png)

![avatar](assets/FmWSz1Y4Bfj7zyDJhc-Rplrz6Yuu.png)
...
![avatar](assets/FnaNXmJuY0OIVStCW2qDnWVOiAO2.png)
...
![avatar](assets/FuR1AQmwzQmyNvmqB4AOqCasWXe0.png)
...
![avatar](assets/FnBOpWKlpdW6_HuQKG8EdmZAPXFG.png))
...
![avatar](assets/FkAn97fsuVQaNKenhCg9DR2AXDNr.png)
