...
![avatar](assets/FqywR5tXyYX2nUX21QYkccxi4aus.png)

### 存储快照用户接口-Restore

有了存储快照之后，如何将快照数据快速恢复过来呢？如下图所示：

![avatar](assets/FmVxlIXPLmxZCmMUXisC9q57olkr.png)
...
![avatar](assets/Fn4TJg9YDp8eV9M9bJ4_lqHjg-Fd.png))
...
![avatar](assets/Fg3fhQOmCjbf1WcuPGryeLAlkvi6.png)
...
![avatar](assets/FhqnT0amePxQJR3N88uvEyz3PmtI.png)
...
![avatar](assets/FrH6aI_eKnOSHARnuGYXmO0ePLqK.png))
...
![avatar](assets/FrCtZOvNrgmr-wgZgSzTm8-Mb8TW.png)
...
![avatar](assets/Fpgq7QCpLYN7uEj8lhCExv5wnxnV.png)
...
![avatar](assets/Fj4GIwbE3-jxXeOO0QPCQIb2rw1q.png)
...
![avatar](assets/FrEdRe8Vlz77avZYBODpMQ_8TGtv.png))
...
![avatar](assets/Fr7qyi0qP1ytDNoVbd3WYZ8-290A.png)
