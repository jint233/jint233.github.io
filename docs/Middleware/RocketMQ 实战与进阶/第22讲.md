...
![第22讲-配图1](assets/第22讲-01.png)

从节点 CPU 毛刺截图：

![第22讲-配图2](assets/第22讲-02.png)
...
```java
Linux version 3.10.0-1062.4.1.el7.x86_64 (root@) (gcc version 4.8.5 20150623 (Red Hat 4.8.5-39) (GCC) ) #1 SMP Fri Oct 18 17:15:30 UTC 2019
```
...
![第22讲-配图3](assets/第22讲-03.jpg)

![第22讲-配图4](assets/第22讲-04.jpg)

说明：上图分别为开启预热时（`warmMapedFileEnable=true`）集群的发送 RT 监控、Broker 开启预热设置时的日志。

**内存传输现象**

![CPU 抖动](assets/第22讲-05.jpg)

![第22讲-配图6](assets/第22讲-06.jpg)

![第22讲-配图7](assets/第22讲-07.jpg)
...
![第22讲-配图8](assets/第22讲-08.jpg)

#### **原因分析**

通过 dump 线程堆栈，如下图：

![第22讲-配图9](assets/第22讲-09.jpg)
