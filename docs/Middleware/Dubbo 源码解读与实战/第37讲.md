...
![Lark20201201-164714.png](assets/第37讲-01.png)
...
![Lark20201201-164718.png](assets/第37讲-02.png)

Cluster 接口继承关系

**在每个 Cluster 接口实现中，都会创建对应的 Invoker 对象，这些都继承自 AbstractClusterInvoker 抽象类**，如下图所示：

![Lark20201201-164728.png](assets/第37讲-03.png)
...
![Lark20201201-164721.png](assets/第37讲-04.png)
