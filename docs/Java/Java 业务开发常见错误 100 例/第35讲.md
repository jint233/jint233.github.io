...
![示意图](assets/第35讲-09.png)

得到以下结果：

![示意图](assets/第35讲-10.png)
...
![示意图](assets/第35讲-13.png)

dashboard 命令用于整体展示进程所有线程、内存、GC 等情况，其输出如下：

![示意图](assets/第35讲-14.png)
