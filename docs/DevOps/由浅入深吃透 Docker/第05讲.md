...
![Lark20200911-162223.png](assets/第05讲-01.png)
...
![Drawing 1.png](assets/第05讲-02.png)
...
![Drawing 2.png](assets/第05讲-03.png)

图 3 注册 Docker Hub 账号

注册完成后，我们可以点击创建仓库，新建一个仓库用于推送镜像。

![Drawing 3.png](assets/第05讲-04.png)
...
Untagged: root@:4f47c01fa91355af2865ac10fef5bf6ec9c7f42ad2321377c21e844427972977
Untagged: localhost:5000/busybox:latest
Untagged: localhost:5000/root@:400ee2ed939df769d4681023810d2e4fb9479b8401d97003c710d0e20f7c49c6
```
...
![Drawing 4.png](assets/第05讲-05.png)
