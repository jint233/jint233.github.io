...
![第07讲 Illustration 01](assets/第07讲-01.png)

针对不同的 DataSource 实现，MyBatis 提供了不同的工厂实现来进行创建，如下图所示，这是工厂方法模式的一个典型应用场景。

![第07讲 Illustration 02](assets/第07讲-02.png)
...
![第07讲 Illustration 03](assets/第07讲-03.png)
...
![第07讲 Illustration 04](assets/第07讲-04.png)
...
![第07讲 Illustration 05](assets/第07讲-05.png)
