...
![第02讲-04](assets/第02讲-04.png) Sharding-JDBC 与 JDBC 规范的兼容性示意图
...
这里给你留一道思考题：ShardingSphere 是一款兼容性很强的开源框架，它的兼容性具体体现在哪些方面？
