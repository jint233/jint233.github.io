...
![Drawing 0.png](assets/第28讲-01.png)
...
![Drawing 1.png](assets/第28讲-02.png)
...
![Drawing 2.png](assets/第28讲-03.png)
...
第二步，从 PROXY_CLASS_COUNTER 字段（AtomicLong 类型）中获取一个 id 值，作为代理类的后缀，这主要是为了避免类名重复发生冲突。
...
![Drawing 3.png](assets/第28讲-04.png)
...
![Dubbo_28 的图（待替换）.png](assets/第28讲-05.png)
