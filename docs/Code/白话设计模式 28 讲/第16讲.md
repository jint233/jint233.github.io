...
![enter image description here](assets/第16讲-02.jpg)
...
![enter image description here](assets/第16讲-03.jpg)
...
1. **发起人（Originator）：** 需要进行备份的对象。
   ...
   2. **备忘录管理者（Caretaker）：** 备份存档的管理者，由它负责与发起人的交互。
...
![enter image description here](assets/第16讲-04.jpg)
