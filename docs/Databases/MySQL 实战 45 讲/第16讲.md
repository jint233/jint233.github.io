...
<figure markdown="span">
  ![图 1 使用 explain 命令查看语句的执行情况](assets/第16讲-01.png)
...
<figure markdown="span">
  ![图 2 city 字段的索引示意图](assets/第16讲-02.png)
...
<figure markdown="span">
  ![图 4 全排序的 OPTIMIZER_TRACE 部分结果](assets/第16讲-04.png)
...
<figure markdown="span">
  ![图 5 rowid 排序](assets/第16讲-05.jpg)
...
<figure markdown="span">
  ![图 6 rowid 排序的 OPTIMIZER_TRACE 部分输出](assets/第16讲-06.png)
...
<figure markdown="span">
  ![图 7 city 和 name 联合索引示意图](assets/第16讲-07.png)
...
<figure markdown="span">
  ![图 8 引入 (city,name) 联合索引后，查询语句的执行计划](assets/第16讲-08.jpg)
...
<figure markdown="span">
  ![图 9 引入 (city,name) 联合索引后，查询语句的执行计划](assets/第16讲-09.png)
...
<figure markdown="span">
  ![图 10 引入 (city,name,age) 联合索引后，查询语句的执行流程](assets/第16讲-10.jpg)
...
<figure markdown="span">
  ![图 11 引入 (city,name,age) 联合索引后，查询语句的执行计划](assets/第16讲-11.png)
...
<figure markdown="span">
  ![图 13 可见性验证方式](assets/第16讲-13.png)
...
<figure markdown="span">
  ![图 14 可见性验证方式 -- 对照](assets/第16讲-14.png)
...
<figure markdown="span">
  ![图 15 binlog_row_image=FULL 读字段逻辑](assets/第16讲-15.png)
