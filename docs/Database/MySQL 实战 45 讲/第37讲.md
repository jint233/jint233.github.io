...
<figure markdown="span">
  ...
  ![图 1 union 语句 explain 结果](assets/第37讲-01.png)
...
<figure markdown="span">
  ...
  ![图 2 union 执行流程](assets/第37讲-02.jpg)
...
<figure markdown="span">
  ...
  ![图 3 union all 的 explain 结果](assets/第37讲-03.png)
...
<figure markdown="span">
  ...
  ![图 4 group by 的 explain 结果](assets/第37讲-04.png)
...
<figure markdown="span">
  ...
  ![图 5 group by 执行流程](assets/第37讲-05.jpg)
...
<figure markdown="span">
  ...
  ![图 6 内存临时表排序流程](assets/第37讲-06.jpg)
...
<figure markdown="span">
  ...
  ![图 7 group by 执行结果](assets/第37讲-07.png)
...
<figure markdown="span">
  ...
  ![图 8 group + order by null 的结果（内存临时表）](assets/第37讲-08.png)
...
<figure markdown="span">
  ...
  ![图 9 group + order by null 的结果（磁盘临时表）](assets/第37讲-09.png)
...
<figure markdown="span">
  ...
  ![图 10 group by 算法优化 - 有序输入](assets/第37讲-10.jpg)
...
<figure markdown="span">
  ...
  ![图 11 group by 优化的 explain 结果](assets/第37讲-11.png)
...
<figure markdown="span">
  ...
  ![图 12 使用 SQL_BIG_RESULT 的执行流程图](assets/第37讲-12.jpg)
...
<figure markdown="span">
  ...
  ![图 13 使用 SQL_BIG_RESULT 的 explain 结果](assets/第37讲-13.png)
