...
![图解](../assets/MySQL 事务日志(redolog 和 undolog)-1.png)
...
![图解](../assets/MySQL 事务日志(redolog 和 undolog)-2.png)
...
![图解](../assets/MySQL 事务日志(redolog 和 undolog)-3.png)
...
![图解](../assets/MySQL 事务日志(redolog 和 undolog)-4.png)
...
![图解](../assets/MySQL 事务日志(redolog 和 undolog)-5.png)
...
![图解](../assets/MySQL 事务日志(redolog 和 undolog)-6.png)
...
![图解](../assets/MySQL 事务日志(redolog 和 undolog)-7.png)
...
![图解](../assets/MySQL 事务日志(redolog 和 undolog)-8.png)
...
![图解](../assets/MySQL 事务日志(redolog 和 undolog)-9.png)
