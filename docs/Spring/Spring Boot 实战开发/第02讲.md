...
![HTTP 请求响应过程](assets/第02讲-08.png)

HTTP 请求响应过程

我们先来看基于 Spring MVC 完成上述开发流程所需要的开发步骤，如下图所示：

![基于 Spring MVC 的 Web 应用程序开发流程](assets/第02讲-09.png)
...
![基于 Spring Boot 的 Web 应用程序开发流程](assets/第02讲-10.png)
...
![Spring Boot 部署包结构](assets/第02讲-11.png)
...
![Spring Boot Web 项目结构图](assets/第02讲-12.png)
...
![Spring Boot 2.2.4 版本的包依赖示意图](assets/第02讲-13.png)
...
![SpringCSS 系统的整体架构图](assets/第02讲-14.png)
