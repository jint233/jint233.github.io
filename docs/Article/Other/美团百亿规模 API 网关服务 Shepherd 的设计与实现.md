...
![img](../assets/美团百亿规模 API 网关服务 Shepherd 的设计与实现-1.jpg)
...
![img](../assets/美团百亿规模 API 网关服务 Shepherd 的设计与实现-2.jpg)
...
![img](../assets/美团百亿规模 API 网关服务 Shepherd 的设计与实现-3.jpg)
...
![img](../assets/美团百亿规模 API 网关服务 Shepherd 的设计与实现-4.jpg)
...
![img](../assets/美团百亿规模 API 网关服务 Shepherd 的设计与实现-5.jpg)
...
![img](../assets/美团百亿规模 API 网关服务 Shepherd 的设计与实现-6.jpg)
...
![img](../assets/美团百亿规模 API 网关服务 Shepherd 的设计与实现-7.jpg)
...
![img](../assets/美团百亿规模 API 网关服务 Shepherd 的设计与实现-8.jpg)
...
![img](../assets/美团百亿规模 API 网关服务 Shepherd 的设计与实现-9.jpg)

### **2.2.2 服务隔离**  **集群隔离** 借鉴公司缓存、任务调度等成熟组件的经验，Shepherd 在设计之初，就考虑了按业务线维度进行集群隔离，也支持重要业务独立部署。如下图所示

![img](../assets/美团百亿规模 API 网关服务 Shepherd 的设计与实现-10.jpg)
...
![img](../assets/美团百亿规模 API 网关服务 Shepherd 的设计与实现-11.jpg)

### **2.2.3 稳定性保障**

Shepherd 提供了一些常规的稳定性保障手段，来保证自身和后端服务的可用性。如下图所示：

![img](../assets/美团百亿规模 API 网关服务 Shepherd 的设计与实现-12.jpg)
...
![img](../assets/美团百亿规模 API 网关服务 Shepherd 的设计与实现-13.jpg)
...
![img](../assets/美团百亿规模 API 网关服务 Shepherd 的设计与实现-14.jpg)
**多维度告警** 有了全面的监控体系，自然少不了配套的告警机制，主要的告警能力包括：

![img](../assets/美团百亿规模 API 网关服务 Shepherd 的设计与实现-15.jpg)

### **2.2.7 故障自愈** Shepherd 服务端接入了弹性伸缩模块，可根据 CPU 等指标进行快速扩容、缩容。除此之外，还支持快速摘除问题节点，以及更细粒度的问题组件摘除

![img](../assets/美团百亿规模 API 网关服务 Shepherd 的设计与实现-16.jpg)
...
![img](../assets/美团百亿规模 API 网关服务 Shepherd 的设计与实现-17.jpg)
**灰度中** ：在 Shepherd 管理平台开启灰度功能，灰度 SDK 将灰度流量转发到网关服务，进行验证。

![img](../assets/美团百亿规模 API 网关服务 Shepherd 的设计与实现-18.jpg)
**灰度后** ：通过灰度流量验证 Shepherd 上的 API 配置符合预期后再迁移。

![img](../assets/美团百亿规模 API 网关服务 Shepherd 的设计与实现-19.jpg)
...
![img](../assets/美团百亿规模 API 网关服务 Shepherd 的设计与实现-20.jpg)
...
![img](../assets/美团百亿规模 API 网关服务 Shepherd 的设计与实现-21.jpg)
...
![img](../assets/美团百亿规模 API 网关服务 Shepherd 的设计与实现-22.jpg)
...
![img](../assets/美团百亿规模 API 网关服务 Shepherd 的设计与实现-23.jpg)
...
![img](../assets/美团百亿规模 API 网关服务 Shepherd 的设计与实现-24.jpg)
