...
在 [第 16 讲](./第16讲.md) 和 [第 34 讲](./第34讲.md) 文章中，我分别和你介绍了 sort buffer、内存临时表和 join buffer。
...
<figure markdown="span">
  ![图 1 union 语句 explain 结果](./assets/402cbdef84eef8f1b42201c6ec4bad4e-1584367402930.png)
  <figcaption>图 1 union 语句 explain 结果</figcaption>
</figure>
...
<figure markdown="span">
  ![图 2 union 执行流程](./assets/5d038c1366d375cc997005a5d65c600e-1584367402931.jpg)
  <figcaption>图 2 union 执行流程</figcaption>
</figure>
...
<figure markdown="span">
  ![图 3 union all 的 explain 结果](./assets/c1e90d1d7417b484d566b95720fe3f6d-1584367402937.png)
  <figcaption>图 3 union all 的 explain 结果</figcaption>
</figure>
...
<figure markdown="span">
  ![图 4 group by 的 explain 结果](./assets/3d1cb94589b6b3c4bb57b0bdfa385d98-1584367402938.png)
  <figcaption>图 4 group by 的 explain 结果</figcaption>
</figure>
...
<figure markdown="span">
  ![图 5 group by 执行流程](./assets/0399382169faf50fc1b354099af71954-1584367402944.jpg)
  <figcaption>图 5 group by 执行流程</figcaption>
</figure>

图中最后一步，对内存临时表的排序，在 [第 17 讲](./第17讲.md) 中已经有过介绍，我把图贴过来，方便你回顾。

<figure markdown="span">
  ![图 6 内存临时表排序流程](./assets/b5168d201f5a89de3b424ede2ebf3d68-1584367402949.jpg)
  <figcaption>图 6 内存临时表排序流程</figcaption>
</figure>
...
<figure markdown="span">
  ![图 7 group by 执行结果](./assets/ae6a28d890efc35ee4d07f694068f455-1584367406944.png)
  <figcaption>图 7 group by 执行结果</figcaption>
</figure>
...
<figure markdown="span">
  ![图 8 group + order by null 的结果（内存临时表）](./assets/036634e53276eaf8535c3442805dfaeb-1584367406944.png)
  <figcaption>图 8 group + order by null 的结果（内存临时表）</figcaption>
</figure>
...
<figure markdown="span">
  ![图 9 group + order by null 的结果（磁盘临时表）](./assets/a76381d0f3c947292cc28198901f9e6e-1584367406944.png)
  <figcaption>图 9 group + order by null 的结果（磁盘临时表）</figcaption>
</figure>
...
<figure markdown="span">
  ![图 10 group by 算法优化 - 有序输入](./assets/5c4a581c324c1f6702f9a2c70acddd19-1584367406945.jpg)
  <figcaption>图 10 group by 算法优化 - 有序输入</figcaption>
</figure>
...
<figure markdown="span">
  ![图 11 group by 优化的 explain 结果](./assets/c9f88fa42d92cf7dde78fca26c4798b9-1584367406945.png)
  <figcaption>图 11 group by 优化的 explain 结果</figcaption>
</figure>
...
<figure markdown="span">
  ![图 12 使用 SQL_BIG_RESULT 的执行流程图](./assets/8269dc6206a7ef20cb515c23df0b846a-1584367406945.jpg)
  <figcaption>图 12 使用 SQL_BIG_RESULT 的执行流程图</figcaption>
</figure>

<figure markdown="span">
  ![图 13 使用 SQL_BIG_RESULT 的 explain 结果](./assets/83b6cd6b3e37dfbf9699cf0ccc0f1bec-1584367406946.png)
  <figcaption>图 13 使用 SQL_BIG_RESULT 的 explain 结果</figcaption>
</figure>
