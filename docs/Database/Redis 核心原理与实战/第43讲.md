...
![第43讲-02](assets/第43讲-02.png)

### RedisStudio

**是否收费**：免费。

**项目介绍**：一款 C++ 编写的 Redis 管理工具，比较老，好久没有更新。
...
![第43讲-03](assets/第43讲-03.png)

### AnotherRedisDesktopManager

**是否收费**：免费。

**项目介绍**：一款基于 Node.js 开发的 Redis 桌面管理器，特点是相对稳定，在数据量比较大时不会崩溃。
...
![第43讲-04](assets/第43讲-04.png)

![第43讲-05](assets/第43讲-05.png)
