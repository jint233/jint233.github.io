...
![第16讲 Architecture](assets/第16讲-01.jpg)
...
![第16讲 Architecture](assets/第16讲-02.jpg)
...
![第16讲 Architecture](assets/第16讲-03.jpg)
...
![第16讲 Architecture](assets/第16讲-04.jpg)

### 2. 将测试请求放入目录

![第16讲 Architecture](assets/第16讲-05.jpg)

### 3. 运行脚本

![第16讲 Architecture](assets/第16讲-06.jpg)

![第16讲 Architecture](assets/第16讲-07.jpg)

### 4. 打开终端，进入 Redis 对应的库，输入 monitor 命令，监控 Redis 命令的执行情况

点击上图“Run”按钮，查看 Redis 命令的执行情况。查看 PostMan 控制台，可以看到有 3 次已经被忽略执行。

![第16讲 Architecture](assets/第16讲-08.jpg)
