...
<figure markdown="span">
  ![图 1 并发 insert 场景](./assets/33e513ee55d5700dc67f32bcdafb9386-1584367406953.png)
  <figcaption>图 1 并发 insert 场景</figcaption>
</figure>
...
<figure markdown="span">
  ![图 2 慢查询日志 -- 将数据插入表 t2](./assets/3efdf8256309a44e23d93089459eda74-1584367406953.png)
  <figcaption>图 2 慢查询日志 -- 将数据插入表 t2</figcaption>
</figure>
...
<figure markdown="span">
  ![图 3 慢查询日志 -- 将数据插入表 t](./assets/6f90b04c09188bff11dae6e788abb918-1584367406953.png)
  <figcaption>图 3 慢查询日志 -- 将数据插入表 t</figcaption>
</figure>
...
<figure markdown="span">
  ![图 4 explain 结果](./assets/d7270781ee3f216325b73bd53999b82a-1584367406953.png)
...
<figure markdown="span">
  ![图 5 查看 Innodb_rows_read 变化](./assets/489281d8029e8f60979cb7c4494010d7-1584367406953.png)
  <figcaption>图 5 查看 Innodb_rows_read 变化</figcaption>
</figure>
...
<figure markdown="span">
  ![图 6 唯一键冲突加锁](./assets/83fb2d877932941b230d6b5be8cca6ca-1584367406954.png)
  <figcaption>图 6 唯一键冲突加锁</figcaption>
</figure>
...
<figure markdown="span">
  ![图 7 唯一键冲突 -- 死锁](./assets/63658eb26e7a03b49f123fceed94cd2d-1584367406954.png)
  <figcaption>图 7 唯一键冲突 -- 死锁</figcaption>
</figure>
...
<figure markdown="span">
  ![图 8 状态变化图 -- 死锁](./assets/3e0bf1a1241931c14360e73fd10032b8-1584367406954.jpg)
  <figcaption>图 8 状态变化图 -- 死锁</figcaption>
</figure>
...
<figure markdown="span">
  ![图 9 两个唯一键同时冲突](./assets/5f384d6671c87a60e1ec7e490447d702-1584367407242.png)
  <figcaption>图 9 两个唯一键同时冲突</figcaption>
</figure>
