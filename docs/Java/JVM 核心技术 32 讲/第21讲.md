...
然后我们在 GitHub 项目的 [releases 页面](https://github.com/chewiebug/GCViewer/releases) 中找到并下载最新版本，例如：[gcviewer-1.36.jar](https://sourceforge.net/projects/gcviewer/files/gcviewer-1.36.jar/download)。
