# 43 以 VS Code 为例，看大型开源项目是如何应用软件工程的？
...
1. VS Code 的需求收集和版本计划
    ...
    ![VS Code 里程碑](assets/第43讲-01.png)
...
2. VS Code 的设计和开发
    ...
    ![Azure DevOps 持续集成](assets/第43讲-02.png)
...
4. VS Code 的发布流程
    ...
    ![VS Code 内部测试版本](assets/第43讲-03.png)
...
它的任务跟踪系统是用的 GitHub 的 Issue 系统，用来收集需求、跟踪 Bug。通过标记不同的 Label 来区分 Issue 的类型和状态，比如 bug 表示 Bug，feature-request 表示功能请求，debt 表示技术债务。通过 Issue 的 Milestone 来标注版本。
