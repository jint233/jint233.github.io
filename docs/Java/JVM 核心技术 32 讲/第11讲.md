...
![749ef972-a71a-475a-a395-ab8e78db5fdf.png](assets/第11讲-01.png)

添加 Remote（不是 Tomcat 下面的那个 Remote Server）：

![f6a45f68-6c1c-4c55-90ae-eae35c2dafc3.png](assets/第11讲-02.png)

然后配置端口号，比如 8888。

![82bb5db4-9dc4-443d-9bb9-00864167c52f.png](assets/第11讲-03.png)
