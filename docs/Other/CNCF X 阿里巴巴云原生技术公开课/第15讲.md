...
![avatar](assets/FlGLRC6CFQW7Xqx5WQmgFXFkPxmh.png)
...
![avatar](assets/FgbvI682-snP7lTv8Efj6TBvtRS2.png)
...
![avatar](assets/FmTz-frFm2fS1jOGoyssX0z-hdI1.png)
...
![avatar](assets/Fh-OqTnu1PrHRpx5ger_CWtRyIXt.png))
...
![avatar](assets/FlHU3ldIkseL6MfY_cFb6BLlK9A2.png))
...
![avatar](assets/FoLmRbN6XO1vVBOKvArpgJNh7trC.png)
...
![avatar](assets/FtR1WQmfbfH6aTzD7oJ5A5v_GC0a.png))
...
![avatar](assets/FtiTc_vfrsua9Bp_DAugf1XmlFhp.png))
...
![avatar](assets/FoN7_vx878Ljhs5xukVQM3C8_Ear.png))
...
![avatar](assets/FjyvOU9o7XaU46Mh5vhJYt_KoZ7v.png))
...
![avatar](assets/Ftca-nUBwx_Fy1wvKF_eif_R9G23.png))
...
![avatar](assets/Fj0CeyV8ku5wg16mzZwIW--vvqtv.png)
...
![avatar](assets/FpUjnQVVQV8mzneN7bBeCLsMSRNH.png)
...
![avatar](assets/FsmUV512mtq1-LByVUuUdOEXKwyq.png)

接下来我们回到 chart.yaml 的文件中，更新一下这个 version 字段，重新做一个打包，这样我们就可以对原来部署好的应用做这样一个版本升级了。

#### 应用上传

![avatar](assets/FgEMgu2zmJm06MshWXVMz7mwAWaV.png)
...
![avatar](assets/FnazvWuaUJi6rkcIhqUNi9VS-ND4.png)
...
![avatar](assets/Fgg7QwtE8dAcRZkVKjLnYf9IOPmD.png)
