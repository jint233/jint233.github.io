...
for ip in ${ips[@]}
do
    scp ~/remote/create_lagou.sh lagou@$ip:~/create_lagou.sh
done
```
...
![死锁避免](assets/第12讲-10.png)

接下来，我们尝试一下免密登录，如下图所示：

![死锁检测](assets/第12讲-11.png)
...
![CAS 操作](assets/第12讲-14.png)

其中有一个环境变量比较重要，就是`PATH`。

![原子操作](assets/第12讲-15.png)
