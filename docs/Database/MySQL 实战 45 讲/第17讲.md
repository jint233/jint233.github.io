...
这里，你可以先回顾一下 [上一篇文章](./第16讲.md) 中全字段排序和 rowid 排序的内容。我把上一篇文章的两个流程图贴过来，方便你复习。
...
在前面 [第 04 讲](./第04讲.md) 和 [第 05 讲](./第05讲.md) 篇介绍索引的文章中，有几位同学问到，如果把一个 InnoDB 表的主键删掉，是不是就没有主键，就没办法回表了？
