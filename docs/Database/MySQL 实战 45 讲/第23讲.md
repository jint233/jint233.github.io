...
在专栏前面文章和答疑篇中，我都着重介绍了 WAL 机制（你可以再回顾下 [第 02 讲](./第02讲.md)、[第 09 讲](./第09讲.md)、[第 12 讲](./第12讲.md) 和 [第 15 讲](./第15讲.md) 文章中的相关内容），得到的结论是：只要 redo log 和 binlog 保证持久化到磁盘，就能确保 MySQL 异常重启后，数据可以恢复。
...
<figure markdown="span">
  ![图 1 binlog 写盘状态](./assets/9ed86644d5f39efb0efec595abb92e3e-1584367394669.png)
  <figcaption>图 1 binlog 写盘状态</figcaption>
</figure>
...
<figure markdown="span">
  ![图 2 MySQL redo log 存储状态](./assets/9d057f61d3962407f413deebc80526d4-1584367394787.png)
  <figcaption>图 2 MySQL redo log 存储状态</figcaption>
</figure>
...
<figure markdown="span">
  ![图 3 redo log 组提交](./assets/933fdc052c6339de2aa3bf3f65b188cc-1584367394795.png)
  <figcaption>图 3 redo log 组提交</figcaption>
</figure>
...
<figure markdown="span">
  ![图 4 两阶段提交](./assets/98b3b4ff7b36d6d72e38029b86870551-1584367394832.png)
  <figcaption> 图 4 两阶段提交</figcaption>
</figure>
...
<figure markdown="span">
  ![图 5 两阶段提交细化](./assets/5ae7d074c34bc5bd55c82781de670c28-1584367394852.png)
  <figcaption>图 5 两阶段提交细化</figcaption>
</figure>
...
在专栏的 [第 02 讲](./第02讲.md) 和 [第 15 讲](./第15讲.md) 文章中，我和你分析了，如果 redo log 和 binlog 是完整的，MySQL 是如何保证 crash-safe 的。今天这篇文章，我着重和你介绍的是 MySQL 是“怎么保证 redo log 和 binlog 是完整的”。
