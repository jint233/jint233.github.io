...
![JDBC 规范整体架构图](assets/第06讲-06.png)
...
![DataSource 类层结构图](assets/第06讲-07.png)
...
![通过 Wrapper 接口扩展 JDBC 规范示意图](assets/第06讲-08.png)
...
![DruidDataSource 的类层结构](assets/第06讲-09.png)
...
![基于 JDBC 规范进行数据库访问的开发流程图](assets/第06讲-10.png)
