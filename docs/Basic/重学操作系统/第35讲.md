...
![socket 通信流程](assets/第35讲-06.png)
...
__PLACEHOLDER_12__plaintext
 ...
 return fd_status_W;
__PLACEHOLDER_13__plaintext
 // The peer disconnected.

 return fd_status_NORW;
__PLACEHOLDER_14__plaintext
...
__PLACEHOLDER_16__plaintext
                    .want_write = ready_to_send};
__PLACEHOLDER_17__plaintext
 // Nothing to send.

 return fd_status_RW;
__PLACEHOLDER_18__plaintext
 if (errno == EAGAIN || errno == EWOULDBLOCK) {
...
__PLACEHOLDER_19__plaintext
 peerstate->sendptr += nsent;

 return fd_status_W;
__PLACEHOLDER_20__plaintext
 ...
 return fd_status_R;
__PLACEHOLDER_21__plaintext
 portnum = atoi(argv[1]);
__PLACEHOLDER_22__plaintext
 perror_die("epoll_create1");
__PLACEHOLDER_23__plaintext
 perror_die("epoll_ctl EPOLL_CTL_ADD");
__PLACEHOLDER_24__plaintext
 die("Unable to allocate memory for epoll_events");
__PLACEHOLDER_25__java
