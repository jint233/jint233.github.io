...
![1613271.png](assets/第26讲-01.png)
...
![82699966.png](assets/第26讲-02.png)

然后在插件安装界面中，找到“可用插件”：

![82770532.png](assets/第26讲-03.png)

勾选“BTrace Workbench”之后，点击“安装(I)”按钮。

> 如果插件不显示，请更新 JDK 到最新版。

![82937996.png](assets/第26讲-04.png)

按照引导和提示，继续安装即可。

![82991766.png](assets/第26讲-05.png)

接受协议，并点击安装。

![83219940.png](assets/第26讲-06.png)

等待安装完成：

![83257210.png](assets/第26讲-07.png)

点击“完成”按钮即可。**BTrace 插件使用**![85267702.png](assets/第26讲-08.png)

打开后默认的界面如下：

![85419826.png](assets/第26讲-09.png)
...
![6182718.png](assets/第26讲-10.png)
...
![8128798.png](assets/第26讲-11.png)

然后我们输入需要连接（Attach）的 JVM 进程，例如 1，然后回车。

![8296362.png](assets/第26讲-12.png)
...
![8871310.png](assets/第26讲-13.png)

环境变量 sysenv：

![9257854.png](assets/第26讲-14.png)

查看线程信息，输入命令 thread：

![8831103.png](assets/第26讲-15.png)
...
![9104344.png](assets/第26讲-16.png)

某些选项可以设置，这里给出了示例 `vmoption PrintGCDetails true`。

查找类 sc：

![9474443.png](assets/第26讲-17.png)

反编译代码 jad：

![9593919.png](assets/第26讲-18.png)

堆内存转储 heapdump：

![9834789.png](assets/第26讲-19.png)

跟踪方法执行时间 trace：

![9997095.png](assets/第26讲-20.png)

观察方法执行 watch：

![10270279.png](assets/第26讲-21.png)
...
![85731ea7-1c8c-4f9a-8869-bd25f61e3300.png](assets/第26讲-22.png)

完成上面的步骤后，可以得到类似这样的信息：

![f6c5d90d-104f-474e-b9fe-fa4d351871da.png](assets/第26讲-23.png)

上图按照每个类被创建的对象数量多少来排序。看第一行可以知道，创建的最多的对象是 int[] 数组。鼠标右键单击这行，就可以看到这些对象都在哪些地方创建的：

![e9583002-b04a-4a2c-8e94-3c9e0e57557a.png](assets/第26讲-24.png)
