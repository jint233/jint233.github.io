...
<img src="../assets/7e75bbfbca0cb932e1256941c99d5f35-1584367408086.png" alt="图1 mysql.user 数据行">
...
1. 内存里，增加一个对象到数组 acl_dbs 中，这个对象的权限位为“全 1”。

图 2 就是这个时刻用户 ua 在 db 表中的状态。

<figure markdown="span">
<img src="../assets/32cd61ee14ad2f370e1de0fb4e39bb2e-1584367408270.png" alt="图2 mysql.db 数据行">
...
<figure markdown="span">
<img src="../assets/d2c30d35be1ba672c8a3017b116e0b3d-1584367408716.png" alt="图3 权限操作效果">
...
<figure markdown="span">
<img src="../assets/9031814361be42b7bc084ad2ab2aa3ec-1584367408972.png" alt="图4 使用 flush privileges">
...
<figure markdown="span">
<img src="../assets/dd625b6b4eb2dcbdaac73648a1af50f1-1584367408977.png" alt="图5 不规范权限操作导致的异常">
