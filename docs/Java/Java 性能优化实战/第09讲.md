...
![Drawing 3.png](assets/第09讲-03.png)
...
![Drawing 5.png](assets/第09讲-04.png)
...
![Drawing 6.png](assets/第09讲-05.png)
...
![Drawing 7.png](assets/第09讲-06.png)
...
HikariCP 官方是不推荐设置 minimumIdle 这个值的，它将被默认设置成和 maximumPoolSize 一样的大小。如果你的数据库 Server 端连接资源空闲较大，不妨也可以去掉连接池的动态调整功能。
...
![Drawing 9.png](assets/第09讲-07.png)
...
![Drawing 10.png](assets/第09讲-08.png)
