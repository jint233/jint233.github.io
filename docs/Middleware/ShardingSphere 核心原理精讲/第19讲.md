...
接下来，我们就对这些 ShardingStrategy 一 一进行展开讨论。
...
而这里用到的各种 ShardingStrategyConfiguration 也都位于 sharding-core-api 工程的 org.apache.shardingsphere.api.sharding.strategy 包下：
