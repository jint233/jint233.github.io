...
![Lark20200904-143159.png](assets/第12讲-02.png)
...
![Lark20200904-143204.png](assets/第12讲-03.png)
...
在本课时最后，留给你一个小问题：在 transport 中创建 EventLoopGroup 的时候，为什么针对 Linux 系统使用的 EventLoopGroup 会有所不同呢？期待你的留言。
