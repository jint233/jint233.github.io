...
![图解](../assets/Java 中 9 种常见的 CMS GC 问题分析与解决-1.jpg)
...
![图解](../assets/Java 中 9 种常见的 CMS GC 问题分析与解决-2.jpg)
...
!!! Note "备注"
    引用计数法是可以处理循环引用问题的，下次面试时不要再这么说啦～~
...
![图解](../assets/Java 中 9 种常见的 CMS GC 问题分析与解决-3.jpg)

把 mark、sweep、compaction、copying 这几种动作的耗时放在一起看，大致有这样的关系：

![图解](../assets/Java 中 9 种常见的 CMS GC 问题分析与解决-4.jpg)
...
![图解](../assets/Java 中 9 种常见的 CMS GC 问题分析与解决-5.jpg)
...
![图解](../assets/Java 中 9 种常见的 CMS GC 问题分析与解决-6.jpg)

#### 常用收集器

目前使用最多的是 CMS 和 G1 收集器，二者都有分代的概念，主要内存结构如下：

![图解](../assets/Java 中 9 种常见的 CMS GC 问题分析与解决-7.jpg)
...
![图解](../assets/Java 中 9 种常见的 CMS GC 问题分析与解决-8.jpg)
...
![图解](../assets/Java 中 9 种常见的 CMS GC 问题分析与解决-9.jpg)
...
![图解](../assets/Java 中 9 种常见的 CMS GC 问题分析与解决-10.jpg)
...
![图解](../assets/Java 中 9 种常见的 CMS GC 问题分析与解决-11.jpg)
...
![图解](../assets/Java 中 9 种常见的 CMS GC 问题分析与解决-12.jpg)
...
- **MetaSpace 内存管理：** 类和其元数据的生命周期与其对应的类加载器相同，只要类的类加载器是存活的，在 Metaspace 中的类元数据也是存活的，不能被回收。每个加载器有单独的存储空间，通过 ClassLoaderMetaspace 来进行管理 SpaceManager_ 的指针，相互隔离的。
...
![图解](../assets/Java 中 9 种常见的 CMS GC 问题分析与解决-13.jpg)
...
![图解](../assets/Java 中 9 种常见的 CMS GC 问题分析与解决-14.jpg)
...
uint ageTable::compute_tenuring_threshold(size_t survivor_capacity) {
  //TargetSurvivorRatio 默认 50，意思是：在回收之后希望 survivor 区的占用率达到这个比例
  ...
  while (age < table_size) {//table_size=16
    total += sizes[age];
    // 如果加上这个年龄的所有对象的大小之后，占用量 > 期望的大小，就设置 age 为新的晋升阈值
...
![图解](../assets/Java 中 9 种常见的 CMS GC 问题分析与解决-15.jpg)

![图解](../assets/Java 中 9 种常见的 CMS GC 问题分析与解决-16.jpg)
...
![图解](../assets/Java 中 9 种常见的 CMS GC 问题分析与解决-17.jpg)

![图解](../assets/Java 中 9 种常见的 CMS GC 问题分析与解决-18.jpg)
...
![图解](../assets/Java 中 9 种常见的 CMS GC 问题分析与解决-19.jpg)
...
![图解](../assets/Java 中 9 种常见的 CMS GC 问题分析与解决-20.jpg)
...
![图解](../assets/Java 中 9 种常见的 CMS GC 问题分析与解决-21.jpg)
...
![图解](../assets/Java 中 9 种常见的 CMS GC 问题分析与解决-22.jpg)
...
![图解](../assets/Java 中 9 种常见的 CMS GC 问题分析与解决-23.jpg)
...
CMS 发生收集器退化主要有以下几种情况。**晋升失败（Promotion Failed）**
...
![图解](https://pic2.zhimg.com/80/v2-8f4de3e5ea0b2bd0658969a24462db41_1440w.jpg)
...
**原因一：主动申请未释放** JVM 使用 -XX:MaxDirectMemorySize=size 参数来控制可申请的堆外内存的最大值。在 Java 8 中，如果未配置该参数，默认和 -Xmx 相等。
...
**原因二：通过 JNI 调用的 Native Code 申请的内存未释放** 这种情况排查起来比较困难，我们可以通过 Google perftools + Btrace 等工具，帮助我们分析出问题的代码在哪里。
...
![图解](../assets/Java 中 9 种常见的 CMS GC 问题分析与解决-24.jpg)
...
![图解](../assets/Java 中 9 种常见的 CMS GC 问题分析与解决-25.jpg)

最终定位到是，项目中对 GIPInputStream 的使用错误，没有正确的 close ()。

![图解](../assets/Java 中 9 种常见的 CMS GC 问题分析与解决-26.jpg)
...
![图解](../assets/Java 中 9 种常见的 CMS GC 问题分析与解决-27.jpg)
...
![图解](../assets/Java 中 9 种常见的 CMS GC 问题分析与解决-28.jpg)
...
![图解](../assets/Java 中 9 种常见的 CMS GC 问题分析与解决-29.jpg)
...
![图解](../assets/Java 中 9 种常见的 CMS GC 问题分析与解决-30.jpg)
...
![图解](../assets/Java 中 9 种常见的 CMS GC 问题分析与解决-31.jpg)
...
![图解](../assets/Java 中 9 种常见的 CMS GC 问题分析与解决-32.jpg)
...
[3]《[深入理解 Java 虚拟机（第 3 版）](https://book.douban.com/subject/34907497/)》 周志明
