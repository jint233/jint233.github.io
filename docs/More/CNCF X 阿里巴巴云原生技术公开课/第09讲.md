...
![第09讲-13](assets/第09讲-13.png)

我们接下来先看一下静态 Provisioning 的 PV 的 yaml 文件。

![第09讲-14](assets/第09讲-14.png)
...
![第09讲-23](assets/第09讲-23.png)

看一下下图对应的 PVC 是不是已经被删掉了。

![第09讲-24](assets/第09讲-24.png)
...
![第09讲-27](assets/第09讲-27.png)

这个 PVC 此时正处在 pending 状态，这就说明它对应的 PV 还在创建过程中。

![第09讲-28](assets/第09讲-28.png)
