...
我们根据一个实例来看一下 Job 是如何来完成下面的应用的。

#### Job 语法

![avatar](assets/FlJHcV-dW9UFVax6IaehPYtKCld-.jpg)
...
![avatar](assets/Fo9k3bh5T3hAJxqA-3hFXVRkYF70.png)
...
![avatar](assets/FhXtzQPMBAE-mI_CZZ1pNtldCOHY.jpg)
...
![avatar](assets/FsfyKX4pZ6ltGRES3Ma1GoCcb-64.png)
...
![avatar](assets/Fv2wyMUcvFwpxCSrNUDdBEP4LeE9.png)
...
![avatar](assets/FmV-DIGuMjGLQS12FhNgSIpi8MsJ.png)
...
![avatar](assets/Fq8EvBaQV8x_2y4-MDw2kob3hGsQ.png)

#### 并行 Job 的编排文件

下面再来看第二个例子：

![avatar](assets/Fv2O65ZDO--pHLz8xicotfl9_zZw.png)

#### 并行 Job 的创建及运行验证

这个例子就是指刚才的并行运行 Job 创建之后，可以看到有第二个并行的 Job。

![avatar](assets/Fk5BhN8oUJVYijYcFib7rfe0vVRx.png)

现在已经有两个 Pod 正在 running，可以看到它大概执行了快到 30s

![avatar](assets/FtXVmf5BjO8BRcc5LuhwXksXOFRD.jpg)

30s 之后它应该会起第二个。

![avatar](assets/FuMQjONTy68OVSKCjTd6iyPUXhdt.jpg)
...
![avatar](assets/Fh_xD3hXSn3EwNuY6pLWrmxxB2VB.jpg)

#### Cronjob 的编排文件

下面来看第三个例子 —— CronJob。 CronJob 是每分钟执行一次，每次一个 job。

![avatar](assets/FhwqFsIjlfL4aUAAEiE0uHaL2Sb1.png)

#### Cronjob 的创建及运行验证

如下图 CronJob 已经创建了，可以通过 get cronjob 来看到当前有一个 CronJob，这个时候再来看 jobs，由于它是每分钟执行一次，所以得稍微等一下。

![avatar](assets/FjIIXBz04a7wvbYbD5plUsy7tRCf.png)
...
![avatar](assets/Ftwts5NgymiBDZRydR_CIcde835x.jpg)
...
![avatar](assets/FlUJ1-4Ofde5w74sDvQ5OrEL66Rb.png)
...
![avatar](assets/FtfcJwcyKLYwjGBjY9qHBGSr7SSA.jpg)
...
![avatar](assets/Fn0gBsJY1Ugr9_M7kNFjcKV3O-0D.png)
...
![avatar](assets/FukQvePjfaEKTrUJeuGIOznO4Qf5.png)
...
![avatar](assets/FgVuatnFylUD_LRK6upX1PxBbwIQ.png)
...
![avatar](assets/FvUc47P919bgEmefYt1kzYntI2ax.png)
...
![avatar](assets/FqqpxDD5zywwJs1YPoFiBFtWN0D_.png)
...
![avatar](assets/FlgZBztBwWxmJ2lFOPMD5NBnQZN5.png)
