...
![第02讲 图4](assets/第02讲-04.png)

### beats+logstath+elasticsearch+kibana

![第02讲 图5](assets/第02讲-05.png)
...
![第02讲 图6](assets/第02讲-06.png)

### beats+MQ+logstash+elasticsearch+kibana

![第02讲 图7](assets/第02讲-07.png)
...
![第02讲 图8](assets/第02讲-08.png)

增加数据源，和使用 MQ

![第02讲 图9](assets/第02讲-09.png)

### Metric 收集和 APM 性能监控

![第02讲 图10](assets/第02讲-10.png)

### 多数据中心方案

通过冗余实现数据高可用

![第02讲 图11](assets/第02讲-11.png)

两个数据采集中心（比如采集两个工厂的数据），采集数据后的汇聚

![第02讲 图12](assets/第02讲-12.png)

数据分散，跨集群的搜索

![第02讲 图13](assets/第02讲-13.png)
