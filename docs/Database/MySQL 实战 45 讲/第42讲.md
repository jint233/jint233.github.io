...
<figure markdown="span">
  ...
  ![图 1 mysql.user 数据行](assets/第42讲-01.png)
...
<figure markdown="span">
  ...
  ![图 2 mysql.db 数据行](assets/第42讲-02.png)
...
<figure markdown="span">
  ...
  ![图 4 使用 flush privileges](assets/第42讲-04.png)
...
<figure markdown="span">
  ...
  ![图 5 不规范权限操作导致的异常](assets/第42讲-05.png)
