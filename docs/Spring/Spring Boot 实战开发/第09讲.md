...
![Repository 接口的部分类层结构图](assets/第09讲-05.png)
...
![方法名衍生查询中查询关键字列表](assets/第09讲-06.png)
...
而最后一种 CREATE_IF_NOT_FOUND 可以理解为是 @Query 注解和方法名衍生查询两者的兼容版。
...
![Spring Data 所提供的组件列表（来自 Spring Data 官网）](assets/第09讲-08.png)
...
**这里，我特别想强调下的是正在孵化的模块，它目前只包含一个组件，即 Spring Data R2DBC。**

R2DBC 是[Reactive Relational Database Connectivity](https://github.com/r2dbc/) 的简写，代表响应式关系型数据库连接，相当于是响应式数据访问领域的 JDBC 规范。
