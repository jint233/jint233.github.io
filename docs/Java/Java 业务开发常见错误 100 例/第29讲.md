...
![image](assets/第29讲-07.png)

![image](assets/第29讲-08.png)

并且，脚本被保存到了数据库：

![image](assets/第29讲-09.png)
...
![image](assets/第29讲-10.png)

![image](assets/第29讲-11.png)
...
![image](assets/第29讲-15.png)

为 test 这个 Cookie 启用了 HttpOnly 属性后，就不能被 document.cookie 读取到了，输出中只有 _ga 一项：

![image](assets/第29讲-16.png)

但是服务端可以读取到这个 cookie：

![image](assets/第29讲-17.png)
