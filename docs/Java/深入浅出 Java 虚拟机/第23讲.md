...
![第23讲 示意图](assets/第23讲-05.jpg)

使用 JITWatch 可以看到，调用了 1 千万次的 for 循环代码，已经被 C2 进行编译了。

![第23讲 示意图](assets/第23讲-06.jpg)
