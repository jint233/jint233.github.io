...
![示意图](assets/第20讲-03.png)

- 集群创建完成后，基本信息中有 API server 公网链接地址

![示意图](assets/第20讲-04.png)

- 连接信息中有 ASK 集群访问凭证

![示意图](assets/第20讲-05.png)
...
![示意图](assets/第20讲-06.png)

###

1. 进行一个简单的 CI 任务

![示意图](assets/第20讲-07.png)
...
![示意图](assets/第20讲-08.png)

![示意图](assets/第20讲-09.png)

### 成本

使用 ASK 与一台预付费 ECS 的成本对比：

![示意图](assets/第20讲-10.png)
