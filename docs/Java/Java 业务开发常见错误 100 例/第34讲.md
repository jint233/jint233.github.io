...
![示意图](assets/第34讲-01.png)

接下来，我会与你介绍些常用的监控工具。你也可以先通过下面这张图了解下各种工具的基本作用：

![示意图](assets/第34讲-02.jpg)
...
![示意图](assets/第34讲-06.png)

点击面板的线程 Dump 按钮，可以查看线程瞬时的线程栈：

![示意图](assets/第34讲-07.png)
