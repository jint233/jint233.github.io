...
<img src="./assets/06f041129783533de9c75580f9decdf5.png" alt="图1 表 t 的磁盘文件" style="max-width: 100%">
...
这里顺便复习一下，我在 [第 21 讲《为什么我只改一行的语句，锁这么多？》](./第21讲.md) 和你介绍的间隙锁加锁规则。
...
<figure markdown="span">
<img src="./assets/e3d83d9ba89de9a6f541c9a2f24a3b0f.png" alt="图5 session B 被锁住信息" style="max-width: 100%">
...
<figure markdown="span">
<img src="./assets/abfa0054ec43d97fb18ba3c1c8829ae7.png" alt="图7 insert 语句报错" style="max-width: 100%">
...
<figure markdown="span">
<img src="./assets/afe662f5e051a2ceb96a87624a589aa8.png" alt="图9 show processlist 结果" style="max-width: 100%">
