...
![第12讲-01](assets/第12讲-01.png) ShardingSphere 源码一级代码结构目录
...
![第12讲-03](assets/第12讲-03.png) ShardingSphere 中 TypeBasedSPI 接口的类层结构
...
在 ShardingSphere 中集成了一批优秀的开源框架，包括用于实现配置中心和注册中心的 Zookeeper、Apollo、Nacos，用于实现链路跟踪的 SkyWalking，用于实现分布式事务的 Atomikos 和 Seata 等。
...
![第12讲-08](assets/第12讲-08.png) sharding-transaction-2pc 代码工程下的子工程
