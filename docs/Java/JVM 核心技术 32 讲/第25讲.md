...
- 分析 hs_err_pid 文件，进程崩溃（crashes）或致命错误(fatal error）会导致 JVM 异常终止。这时候 JVM 会自动生成 hs_err_pid 文件。这个文件中包含大量的信息，可以用 FastThread 来帮助我们进行分析。
...
### **文件上传方式**![第25讲 Image 1](assets/第25讲-01.png)

选择文件并上传，然后鼠标点击“分析”（Analyze）按钮即可。

### **上传文本方式**![第25讲 Image 2](assets/第25讲-02.png)
...
![6843295.png](assets/第25讲-03.png)
...
![6864312.png](assets/第25讲-04.png)
...
![6898070.png](assets/第25讲-05.png)
...
![7358293.png](assets/第25讲-16.png)
