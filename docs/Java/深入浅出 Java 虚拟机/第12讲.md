...
**swap 是很多性能场景的万恶之源，建议禁用。** 当你的应用真正高并发了，SWAP 绝对能让你体验到它魔鬼性的一面：**进程倒是死不了了，但 GC 时间长得却让人无法忍受。**

## 5. 内存泄漏

![第12讲 示意图](assets/第12讲-06.jpg)
