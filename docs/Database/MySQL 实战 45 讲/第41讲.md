...
<figure markdown="span">
  ![图 1 mysqldump 输出文件的部分结果](./assets/8acdcefcaf5c9940570bf7e8f73dbdde-1584367407247.png)
  <figcaption>图 1 mysqldump 输出文件的部分结果</figcaption>
</figure>
...
<figure markdown="span">
  ![图 2 load data 的同步流程](./assets/3a6790bc933af5ac45a75deba0f52cfd-1584367390347.jpg)
  <figcaption>图 2 load data 的同步流程</figcaption>
</figure>
...
<figure markdown="span">
  ![图 3 物理拷贝表](./assets/ba1ced43eed4a55d49435c062fee21a7-1584367390359.jpg)
  <figcaption>图 3 物理拷贝表</figcaption>
</figure>
...
!!! Quote "评论区留言点赞板"
    ...
    这是因为 next-key lock 是先加间隙锁，再加记录锁的。加间隙锁成功了，加记录锁就会被堵住。如果你对这个过程有疑问的话，可以再复习一下 [第 30 讲](./第30讲.md) 中的相关内容。
