...
<figure markdown="span">
  ![Spring 家族技术体系](./assets/Ciqc1F-7VlGAesWiAACRuk5Qiko663.png)
...
<figure markdown="span">
  ![Spring Framework 整体架构图](./assets/Ciqc1F-7XBiAUUZ5AACAA4yJiFs420.png)
...
<figure markdown="span">
  ![Spring Boot 整体架构图](./assets/CgqCHl-7XCSAItYWAAFzNlJiVbU854.png)
...
<figure markdown="span">
  ![Spring Cloud 与微服务整体架构图（来自 Spring 官网）](./assets/CgqCHl-7VsqAU_-oAAA1B5IapO8742.png)
...
<figure markdown="span">
  ![Spring Cloud 核心功能组件](./assets/Ciqc1F-7Vt-ANEHuAACBTY1pIak300.png)
...
<figure markdown="span">
  ![响应式编程技术栈与 Servlet 技术栈之间的对比图](./assets/Ciqc1F-7VumAJcdAAACWjgTTFkY645.png)
...
![3.png](assets/Ciqc1F-8pB6AReQhAADiHs1UMA4354.png){style="width:60%;max-width:600px"}
