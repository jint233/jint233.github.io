...
![图片 1.png](assets/CgqCHl-06zuAdxB_AAKnPyI9NhA898.png){style="max-width:600px;width:100%"}
...
![图片 2.png](assets/CgqCHl-060uANzIXAAK8c10kJxc818.png)
...
![图片 3.png](assets/Ciqc1F-063GAc4TOAATJbR2Lmao239.png)

当发生 GC 时， DirectByteBuffer 对象被回收，内存中的对象引用情况发生了如下变化：

![图片 4.png](assets/Ciqc1F-063eAQ7AiAAPPC1-cL1I933.png)
