...
![enter image description here](assets/第03讲-01.jpg)
...
![enter image description here](assets/第03讲-02.jpg)
...
2. 表示状态的类应该只会有一个实例，因为不可能出现“固态 1”、“固态 2”的情形，所以状态类的实现要使用单例，关于单例模式，会在下一章中进一步讲述。
...
![enter image description here](assets/第03讲-03.jpg)
