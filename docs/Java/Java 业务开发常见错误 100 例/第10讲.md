...
```plaintext
12:50:39.445 [main] INFO org.geekbang.time.commonmistakes.collection.aslist.AsListApplication - list:[[user@host.com] size:1 class:class [I
```
...
![image](assets/第10讲-01.png)

![image](assets/第10讲-02.png)
