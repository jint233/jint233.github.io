...
![第15讲 示意图](assets/第15讲-01.jpg)

下图是切换到 MBean 选项卡之后的截图，可以看到图中展示的 Metaspace 详细信息。

![第15讲 示意图](assets/第15讲-02.jpg)
...
我们先简单看一下 JVM 监控的整体架构图： ![第15讲 示意图](assets/第15讲-08.jpg)
...
![第15讲 示意图](assets/第15讲-09.png)

在导入之前，还需要创建一个数据源，选择 influxdb，填入 db 的地址即可。

![第15讲 示意图](assets/第15讲-10.jpg)
