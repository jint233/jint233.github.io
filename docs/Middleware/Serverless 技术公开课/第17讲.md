...
![image.png](assets/第17讲-09.png)

下图为 SparkApplication 状态机：

![image.png](assets/第17讲-10.png)

#### Serverless Kubernetes + ECI

那么，如果在 Serverless Kubernetes 集群中运行 Spark，其实际上是对原生 Spark 的进一步精简。

![image.png](assets/第17讲-11.png)

#### 存储选择

![image.png](assets/第17讲-12.png)
