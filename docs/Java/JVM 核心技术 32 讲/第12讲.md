...
![enter image description here](assets/第12讲-01.png)

也可以直接调用方法，例如查看 VM 参数：

![enter image description here](assets/第12讲-02.png)

如果启动的进程是 Tomcat 或者是 Spring Boot 启动的嵌入式 Tomcat，那么我们还可以看到很多 Tomcat 的信息：

![enter image description here](assets/第12讲-03.png)
...
![enter image description here](assets/第12讲-04.png)

查看 User 的属性：

![enter image description here](assets/第12讲-05.png)

直接修改 UserName 的值：

![enter image description here](assets/第12讲-06.png)
