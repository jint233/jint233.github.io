# 10 第 09 讲：案例实战：面对突如其来的 GC 问题如何下手解决
...
尤其注意的是最后一行日志，需要详细描述。可以看到 G C 花费的时间，竟然有 3 个数值。这个数值你可能在多个地方见过。如果你手头有 Linux 机器，可以执行以下命令：

time ls /

![第10讲 示意图](assets/第10讲-04.jpg)
...
![第10讲 示意图](assets/第10讲-10.jpg)

下面这个是典型的内存泄漏。

![第10讲 示意图](assets/第10讲-11.jpg)
...
> GitHub 地址：[https://gitee.com/xjjdog/jvm-lagou-res](https://gitee.com/xjjdog/jvm-lagou-res)
...
YGC 代表的是年轻代的回收次数，YGC T 对应的是年轻代的回收耗时。那么 FGC 肯定代表的是 Full GC 的次数。
...
[《Linux 生产环境上，最常用的一套“Sed“技巧》](https://mp.weixin.qq.com/s/wP9_wvoTARRrlszsOmvMgQ)

[《Linux 生产环境上，最常用的一套“AWK“技巧》](https://mp.weixin.qq.com/s/aRy3QlMUpSNOKf2pyN6Uuw)
