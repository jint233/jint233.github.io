...
![第27讲 Image 1](assets/第27讲-01.jpg)
...
![第27讲 Image 2](assets/第27讲-02.jpg)
...
![第27讲 Image 3](assets/第27讲-03.jpg)
...
![第27讲 Image 4](assets/第27讲-04.jpg)
...
![第27讲 Image 5](assets/第27讲-05.jpg)
...
![第27讲 Image 6](assets/第27讲-06.jpg)

```shell
ovs-vsctl set port first_br @ -- @ create qos type=linux-htb other-config:max-rate=10000000 @,@,@ -- @ create queue other-config:min-rate=3000000 other-config:max-rate=10000000 -- @ create queue other-config:min-rate=1000000 other-config:max-rate=10000000 -- @ create queue other-config:min-rate=6000000 other-config:max-rate=10000000
```
