...
![图片 1.png](assets/第14讲-03.png)

我们用一张图来直观地概括下这几个状态的演变：

![第14讲 Image 4](assets/第14讲-04.png)
...
处于 TIMED_WAITING、WATING、BLOCKED 状态的线程是不消耗 CPU 的，而处于 RUNNABLE 状态的线程要结合当前线程代码的性质判断是否消耗 CPU：
