...
![第07讲-07](assets/第07讲-07.png)

#### 并行 Job 的编排文件

下面再来看第二个例子：

![第07讲-08](assets/第07讲-08.png)

#### 并行 Job 的创建及运行验证

这个例子就是指刚才的并行运行 Job 创建之后，可以看到有第二个并行的 Job。

![第07讲-09](assets/第07讲-09.png)

现在已经有两个 Pod 正在 running，可以看到它大概执行了快到 30s

![第07讲-10](assets/第07讲-10.jpg)

30s 之后它应该会起第二个。

![第07讲-11](assets/第07讲-11.jpg)
