...
![第21讲 Image 1](assets/第21讲-01.jpg)
...
![第21讲 Image 2](assets/第21讲-02.jpg)

可以看到检测到了内存问题。

## 2. JVM 内存大小分析

![第21讲 Image 3](assets/第21讲-03.jpg)

这里有对内存的分配情况的细节图表。

**3. GC 暂停时间的分布情况** 关键的性能指标：平均 GC 暂停时间 45.7ms，最大暂停时间 70.0ms。绝大部分 GC 暂停时间分布在 30~60ms，占比 89%。

![第21讲 Image 4](assets/第21讲-04.jpg)

**4. GC 之后的内存情况统计** GC 执行以后堆内存的使用情况。

![第21讲 Image 5](assets/第21讲-05.jpg)

**5. GC 情况汇总统计信息** 可以看到 Full GC 是影响性能的绝对大头。

![第21讲 Image 6](assets/第21讲-06.jpg)

![第21讲 Image 7](assets/第21讲-07.jpg)

**6. 内存分配速度** 内存分配的速度越快，说明我们程序里创建对象越频繁。

![第21讲 Image 8](assets/第21讲-08.jpg)

**7. 内存泄漏、长暂停、安全点等信息** 没有检测到内存泄漏。

![第21讲 Image 9](assets/第21讲-09.jpg)

**8. GC 原因汇总** 可以看到 GC 发生的原因，其中 566 次是 GC 策略自己调整的（Ergonomics），32 次是因为分配失败导致的。

![第21讲 Image 10](assets/第21讲-10.jpg)

## 9. 其他信息

![第21讲 Image 11](assets/第21讲-11.jpg)
...
![第21讲 Image 12](assets/第21讲-12.jpg)
...
![第21讲 Image 13](assets/第21讲-13.jpg)
...
![第21讲 Image 16](assets/第21讲-16.jpg)
...
![第21讲 Image 17](assets/第21讲-17.jpg)
...
![第21讲 Image 18](assets/第21讲-18.jpg)
