...
![使用 Spring Initializer 创建 Web 应用程序示意图](assets/第03讲-04.png)
...
这时我们通过 Postman 访问“[http://localhost:8083/customers/1](http://localhost:8083/customers/1)”端点，可以得到如下图所示的 HTTP 响应结果，说明整个服务已经启动成功。

![好了，现在我们已经明白如何构建、打包以及运行一个简单的 Web 应用程序了，这是一切开发工作的起点，后续所有的案例代码我们都将通过这种方式展现在你面前，包括接下来要介绍的 Spring Boot 配置体系也是一样。](assets/第03讲-05.png)
