...
![SpringCSS 案例系统中三个服务的交互方式图](assets/第11讲-05.png)
...
![RESTful 风格示例](assets/第11讲-06.png)
...
![使用 Postman 输入 JSON 字符串发起 HTTP 请求示例图](assets/第11讲-07.png)
...
![RESTful 风格对比示例](assets/第11讲-08.png)
