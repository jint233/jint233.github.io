...
![添加 Spring Security 之后自动出现的登录界面](assets/第18讲-05.png)
...
![使用 Postman 来完成认证信息的设置](assets/第18讲-06.png)
...
从上面的代码中，我们看到系统中存在"springcss _user"和"springcss_admin"这两个用户，其密码分别是"password1"和"password2"，分别代表着普通用户 USER 及管理员 ADMIN 这两个角色。
...
![Spring Security 中用户认证相关类结构图](assets/第18讲-07.png)
...
![Spring Security 中的 PasswordEncoder 实现类](assets/第18讲-08.png)
