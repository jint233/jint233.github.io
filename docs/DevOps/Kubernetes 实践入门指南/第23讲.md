...
```shell
[root@ ~]$ kubectl get pvc nfs-pvc
NAME      STATUS   VOLUME   CAPACITY   ACCESS MODES   STORAGECLASS   AGE
nfs-pvc   Bound    nfs-pv   10Gi       RWX            nfs            3m54s
[root@ ~]$
[root@ ~]$ kubectl get pv nfs-pv
    ...
    - name: nginx
      ...
      volumeMounts:
        - mountPath: "/usr/share/nginx/html"
          name: nginx-pv-storage
复制
[root@ ~]$ kubectl create -f nfs-pv-pod.yaml
pod/nginx-pv-pod created
[root@ ~]$
[root@ ~]$ kubectl get pod nginx-pv-pod -o wide
NAME           READY   STATUS    RESTARTS   AGE   IP              NODE           NOMINATED NODE   READINESS GATES
nginx-pv-pod   1/1     Running   0          66s   172.16.140.28   k8s-worker-2   <none>           <none>
[root@ ~]$ curl http://172.16.140.28
...
- [https://zh.wikipedia.org/wiki/Quorum_(%E5%88%86%E5%B8%83%E5%BC%8F%E7%B3%BB%E7%BB%9F)](<https://zh.wikipedia.org/wiki/Quorum_(%E5%88%86%E5%B8%83%E5%BC%8F%E7%B3%BB%E7%BB%9F)>)
