...
![图解](../assets/Java 中的 SPI-3.png)

下面再创建一个用来测试的 module，名为：spi-app。

![图解](../assets/Java 中的 SPI-4.png)
