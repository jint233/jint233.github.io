...
- 云上的集群
    ...
    ![第13讲 图1](assets/第13讲-01.png)

- 集群里的盒子

云里面的每个白色正方形的盒子代表一个节点——Node。

![第13讲 图2](assets/第13讲-02.png)

- 节点之间

在一个或者多个节点直接，多个绿色小方块组合在一起形成一个 ElasticSearch 的索引。

![第13讲 图3](assets/第13讲-03.png)

- 索引里的小方块

在一个索引下，分布在多个节点里的绿色小方块称为分片——Shard。

![第13讲 图4](assets/第13讲-04.png)

- Shard＝Lucene Index

一个 ElasticSearch 的 Shard 本质上是一个 Lucene Index。

![第13讲 图5](assets/第13讲-05.png)
...
- Segment 内部（有着许多数据结构）：
  ...
  ![第13讲 图7](assets/第13讲-07.png)

#### Inverted Index

最最重要的 Inverted Index

![第13讲 图8](assets/第13讲-08.png)
...
![第13讲 图17](assets/第13讲-17.png)

随着时间的增加，我们会有很多 segments，

![第13讲 图18](assets/第13讲-18.png)

所以 ElasticSearch 会将这些 segment 合并，在这个过程中，segment 会最终被删除掉

![第13讲 图19](assets/第13讲-19.png)
...
![第13讲 图25](assets/第13讲-25.png)

在上种情况下，每个 index 有两个 shards

- **如何 Scale**

  ![第13讲 图26](assets/第13讲-26.png)

shard 不会进行更进一步的拆分，但是 shard 可能会被转移到不同节点上

![第13讲 图27](assets/第13讲-27.png)
...
- 节点分配与 Shard 优化
  ...
  ![第13讲 图28](assets/第13讲-28.png)

- **路由 Routing**

每个节点，每个都存留一份路由表，所以当请求到任何一个节点时，ElasticSearch 都有能力将请求转发到期望节点的 shard 进一步处理。

![第13讲 图29](assets/第13讲-29.png)

## 一个真实的请求

![第13讲 图30](assets/第13讲-30.png)

- **Query**

    ![第13讲 图31](assets/第13讲-31.png)

Query 有一个类型 filtered，以及一个 multi_match 的查询

- **Aggregation**

    ![第13讲 图32](assets/第13讲-32.png)
...
![第13讲 图33](assets/第13讲-33.png)

- **上帝节点**

    ![第13讲 图34](assets/第13讲-34.png)

这时这个节点就成为当前请求的协调者（Coordinator），它决定： a) 根据索引信息，判断请求会被路由到哪个核心节点 b) 以及哪个副本是可用的 c) 等等

- **路由**

    ![第13讲 图35](assets/第13讲-35.png)

- **在真实搜索之前**

ElasticSearch 会将 Query 转换成 Lucene Query

![第13讲 图36](assets/第13讲-36.png)

然后在所有的 segment 中执行计算

![第13讲 图37](assets/第13讲-37.png)

对于 Filter 条件本身也会有缓存

![第13讲 图38](assets/第13讲-38.png)

但 queries 不会被缓存，所以如果相同的 Query 重复执行，应用程序自己需要做缓存

![第13讲 图39](assets/第13讲-39.png)
...
![第13讲 图40](assets/第13讲-40.png)

![第13讲 图41](assets/第13讲-41.png)

![第13讲 图42](assets/第13讲-42.png)

![第13讲 图43](assets/第13讲-43.png)

![第13讲 图44](assets/第13讲-44.png)
