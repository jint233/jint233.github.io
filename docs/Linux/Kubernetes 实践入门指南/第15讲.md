...
![第15讲 image 1](assets/第15讲-01.jpg)
...
![service-dnat-ip](assets/第15讲-02.jpg)
...
![13-3-dnat-5-tuple](assets/第15讲-03.jpg)
...
**后端支持接入 SSL 案例** 默认情况下，Nginx 使用 HTTP 来到达服务。在 Ingress 规则中添加注解：
...
**Session Affinity 和 Cookie affinity** 注解：
